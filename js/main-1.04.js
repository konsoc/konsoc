	...
	function requestRenderData() {
		...
		mapDeaths.clicked = function (countryID) {
			...
			*/
			...
			chartCovidOptions.title.text = svgMapCountryNames[countryID];
		...
		var dataDeath, dataVac, dataManufecturer, dataNewCases;
		var deathDates = [];
		...
		function parseData() {
			...
			chartSelectedCountry.hideSeries(__('mortality_rate'));
